...
;Problem 9
(lambda (f g t) (+ 4 f (+ 4 5) (* g t)))
;expect (lambda (f g t) (+ 4 f (+ 4 5) (* g t)))
((lambda (f g t) (+ 4 f (+ 4 5) (* g t))) 3 4 5)
;expect 36

;Problem 10
(define (add-5 num) (+ num 5))
;expect add-5
(define (sub-99 num) (- num 99))
;expect sub-99
(sub-99 (add-5 6))
;expect -88
...
(define g (mu() (* a f)))
;expect g
(define dd (lambda() (define a 4) (define f 5) (g)))
;expect dd
(dd)
;expect 20
